...
export default function ByAccount() {
  ...
  const { data: chatsByAccount, isLoading, error, refetch } = trpc.chats.byAccount.useQuery();
  ...
  return (
    <DashboardLayout>
      <div className="p-6 max-w-7xl mx-auto">
        <div className="mb-8">
          <h1 className="text-3xl font-bold text-primary mb-2">Chats by Account</h1>
          <p className="text-muted-foreground">Browse your conversations organized by account</p>
        </div>
        ...
        {error && (
          <ErrorAlert
            ...
            message="There was an error loading chats by account. Please try again."
            onRetry={() => refetch()}
            onDismiss={() => {}}
          />
        )}
        ...
        <div className="space-y-4">
          ...
          ) : chatsByAccount && Object.keys(chatsByAccount).length > 0 ? (
            Object.entries(chatsByAccount).map(([account, chats]: [string, any]) => {
